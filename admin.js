// https://eduardocarvalhoo1.github.io/DoeVida/
document.addEventListener('DOMContentLoaded', function() {
  ...
  function pesquisa() {
      ...
      listItems.forEach(listItem => {
          ...
          if (textContent.includes(searchTerm)) {
              listItem.style.display = 'block'; // Display matching items
          } else {
  ...
  document.getElementById('pesquisar').addEventListener('input', pesquisa);

  // Ao apertar enter não envia o formulario 
